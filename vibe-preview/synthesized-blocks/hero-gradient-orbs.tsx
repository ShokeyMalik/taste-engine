...
export function HeroGradientOrbs({
  title = "Ship Taste Engine Synthesized to Production Faster",
  description = "The Unified Design Intelligence Platform powering the world with Blended Visuals. High-fidelity motion meet industrial precision.",
